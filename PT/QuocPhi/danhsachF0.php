...
<path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
                                ...
                                <form id="search">
                        <input type="text" name="TenF0" placeholder="Tìm kiếm F0">
                    </form>
                            </div>
                                        ...
                                        <p>
										 ...
										 $tenf0=$_REQUEST['TenF0'];
										  if(isset($_REQUEST['TenF0'])){
											  $p->loadtintuc("select * from f0 where TenF0 LIKE '%$tenf0%' order by MaF0 asc ");
											  }
											  else if($mabv==1){
										  $p->loadtintuc("select * from f0 where Mabenhvien='$mabv' or Mabenhvien=0  order by MaF0 asc");}
                                          else{ $p->loadtintuc("select * from f0 where Mabenhvien='$mabv'   order by MaF0 asc");}
                                          ?>
                                        </p>
                                        <p>&nbsp;</p>
                                      <p>&nbsp; </p>
