...
{
	header("Location:danhsachxacnhan.php");	
}
...
<html lang="en">
    <head>
        ...
        <!-- site metas -->
        <title>Xác nhận yêu cầu khám</title>
     ...
     <ul class="sub_menu">
            ...
            <div> <form action="" method="post">
                                         ...
                                         <table width="464" align="center" class="tableStyle">
                                              <tr>
                                                <th colspan="2" align="center" valign="middle" scope="col"><h1 align="center"><strong>Xác nhận yêu cầu khám</strong></h1> </th>
                                           </tr><br>
                                              <tr  height="30px">
                                                <td width="173" ><strong>Mã lịch khám</strong></td>
                                                <td width="271"  align="left"><div align=""><strong>
                                                <input type="text" name="txtma" id="txtma" class="col-sm-12" value="<?php echo $p->luachon("select Malich from lichkham where MaF0 ='$MaF0' ") ?>"  readonly>
                                                </strong></div></td>
                                              </tr>
                                              ...
                                              <tr  height="50px">
                                                ...
                                                <td align="left"><div><strong>
                                                <input type="text" name="txtmaf0" id="txtmaf0" class="col-sm-12" value="<?php echo $p->luachon("select TenF0 from lichkham where 	MaF0 ='$MaF0' ") ?>" readonly>
                                                </strong></div></td>
                                              </tr>
                                              
                                              <tr  height="50px">
                                                <td valign=""><strong>Thời gian</strong></td>
                                                <td align="left"><strong>
                                                <input type="text" name="txttg" id="txttg" class="col-sm-12" value="<?php echo $p->luachon("select thoigian from lichkham where MaF0 ='$MaF0' ") ?>" readonly>
                                                </strong></td>
                                              </tr>
                                              <tr  height="50px">
                                                <td valign=""><div align=""><strong>Tình trạng</strong></div></td>
                                              
                                                <td align="left"><div align=""> <strong>
                                                    <?php 
                                                     $n=$p->luachon("select Tinhtrangsuckhoe from lichkham where MaF0 ='$MaF0'");
                                                    $p->themcty('select * from trangthaiphieu',$n);
                                              ...
                                              <tr>
                                                <td colspan="2" align="center"><div align="center">
                                                  <strong>
                                                  <input type="submit" name="them" id="them" value="Thay đổi trạng tháii"  style="background-color:#73BE55; color:white;"/>
                                           ...
                                           <div align="center">
                                            <?php
                                                switch ($_POST['them'])
                                              {
                                                   case'Thay đổi trạng tháii':
                                                  {
													  
                                                        $Maf0=$_REQUEST['txtma'];
														$tinhtrang=$_REQUEST['tt'];
                                                       $$n=$p->luachon("select Tinhtrangsuckhoe from lichkham where MaF0 ='$MaF0'");

                                                      if($n==3)
                                                      {
                                                        echo '<script type="text/javascript"> alert("Đã hủy không thể thay đổi");
														   

                                                        </script>';
                                                      }
                                                      
                          					else if($p->themxoasua("UPDATE lichkham SET Tinhtrangsuckhoe = '$tinhtrang' WHERE Malich='$Maf0'")==1)
                                                         {
                                                            header("location:danhsachxacnhan.php");    
                                                         }
                                                        else
