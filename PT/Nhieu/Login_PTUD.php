...
<form  id="form1" name="form1" method="post" action="">
  <table width="802" border="1" align="center" cellpadding="5">
    <tr style="margin-top:20px">
      <td style=" color:#03F" height="90" colspan="2"  align="center"bgcolor="#99CC99"><h3><strong>ĐĂNG NHẬP ADMIN</strong></h3></td>
    </tr>
    <tr>
      <td style=" color:#03F" width="111" height="58" align="center" valign="middle"><strong>USERNAME</strong></td>
      <td width="281"><label for="txtuser"></label>
      <input  name="txtuser" type="text" id="txtuser" size="40" /></td>
    </tr>
    <tr>
      <td style=" color:#03F" height="58" align="center"><strong>PASSWORD</strong></td>
      <td><label for="txtpass"></label>
      <input  name="txtpass" type="password" id="txtpass" size="40" /></td>
    </tr>
    <tr>
      <td height="57" colspan="2" align="center"bgcolor="#99CC99"><input class="btn btn-primary" type="submit" name="nut" id="nut" value="Đăng nhập" />
        <strong>
      <input class="btn btn-primary" type="reset" name="button2" id="button2" value="Hủy" />
      </strong></td>
    </tr>
  </table>
  <div align="center">
